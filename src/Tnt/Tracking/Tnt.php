        ...
        return [
            'localizaMercadoria' => [
                'in0' => [
                    ...
                    'nf' => new \SoapVar($this->invoiceNumber, XSD_INT, 'int', null, 'nf', 'http://model.localizacao.mercurio.com'),
                    'nfSerie' => new \SoapVar($this->invoiceSeries, XSD_STRING, 'string', null, 'nfSerie', 'http://model.localizacao.mercurio.com'),
                    'pedido' => new \SoapVar($this->orderNumber, XSD_INT, 'int', null, 'pedido', 'http://model.localizacao.mercurio.com'),
